        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex flex-col gap-6 sm:block">
            <div className="relative">
              <Image
                src="https://res.cloudinary.com/ecosheane/image/upload/v1744531862/accordio-img-2.jpg_oq9ubx.png"
                alt="Person 1"
                width={300}
                height={200}
            ...
            <div className="relative">
              <Image
                src="https://res.cloudinary.com/ecosheane/image/upload/v1744531861/accordio-img-1.jpg_p6aymv.png"
                alt="Person 2"
                width={300}
                height={200}
                className="rounded-lg  mx-auto"
