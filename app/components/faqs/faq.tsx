  ...
  Payment: [
    {
      ...
      answer: "We accept multiple payment methods, including credit cards, PayPal, and crypto payments.",
    },
  ],
  "Data Privacy": [
    {
      question: "How is user data protected?",
      answer: "We use industry-standard encryption and strict policies to ensure user data privacy.",
    },
  ],
  "Data Security": [
    {
      question: "What security measures are in place?",
      answer: "We employ multi-layered security systems and regular audits to prevent breaches.",
    },
  ],
  "Technical Issues": [
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="container text-black mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Explore these questions to discover how our AI solutions can enhance customer engagement, improve efficiency, and reduce operational costs.
              </p>
            </div>
          ...
          <div className="border border-gray-200 rounded-lg p-6 shadow-sm text-center">
            ...
            <p className="text-gray-600 mt-2">Contact our support team for further assistance.</p>
            <button className="mt-4 px-4 py-2 bg-orange-400 text-white rounded-lg">
              Contact Support
            </button>
          </div>
        </div>
